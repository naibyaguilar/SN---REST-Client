...
async function RenderRegister(req, res) {
    res.status(200).render('../views/auth/register', {
        title: 'Registrarse',
        message: undefined
    });
}
...
async function Register(req, res) {
    try {
        if (!req.body.email || !req.body.password || !req.body.fullName || !req.body.academyProfile) {
...
module.exports = { RenderLogin, RenderRegister, Login, Register }